        ...
        <div className='container-fluid'>
          ...
          <div className='formbox1'>
            ...
            <div className='formboxs'>
              <h2 className="text-center" style={{ color: "black" }}>Update Profile</h2>
              <form className='centerbox'>
                <div className='row'>
                  <div className='col-md-3'>
                    <div className='editprobox'>
                ...
                <div className='row'>
                  ...
                  <div className="col-md-6">
                    {dob === "" || dob === "0000-00-00" ? <input type="date" name="date" placeholder='DOB' value={dob} onChange={(e) => { setdob(e.target.value) }} /> : <input type="date" name="date" placeholder='DOB' value={dob} onChange={(e) => { setdob(e.target.value) }} readOnly />}<br />
                ...
                <div className="row">
                  <div className="col-md-6">
                    <input type="text" name="town" placeholder='Town' value={town} onChange={(e) => { settown(e.target.value) }} /><br />

                  </div>
                  <div className="col-md-6">
                    <input type="text" name="state" placeholder='State/CountryProvince' value={state} onChange={(e) => { setstate(e.target.value) }} /><br />
                ...
                <div className='centered' >
                  <Button className='  btnbox text-center mb-3' id="submit-editprofile" style={{ backgroundColor: color }} onClick={editprofile}>Update Profile</Button>
                  <br />
