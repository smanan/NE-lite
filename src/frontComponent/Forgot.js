...
export default function ChangesPassword(props) {
  ...
  return <>
    ...
    <div className='container-fluid'>
      <div className='maincontainer'>
        ...
        <div className='formbox'>
          ...
          <div className='formboxs p-5' style={{ margin: "9px" }}>
            ...
            <form className='centerbox '  >
              ...
              <div className='passwordbox'>
                ...
                <input className='passinputbox' type="email" name='email' onChange={checkemail} value={email} placeholder='Enter Email'
                />
              ...
              <div className='centered'>
                <Button className=' btnbox text-center mb-3' style={{ backgroundColor: color }} disabled={disabledvalue} id="submit-forgot" onClick={forgetpassword}> Forget Password</Button>
    ...
    {close ? <>  <div className='modalmaindiv' id='welcomeDiv'>
